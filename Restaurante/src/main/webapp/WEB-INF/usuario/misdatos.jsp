...
<form class="well col-md-6 col-md-offset-3" id="formulario" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="nick" name="nick" placeholder="Nombre de Usuario" value="<s:property value="usuario.nick"/>">
    </div>
